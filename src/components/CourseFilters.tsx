      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full rounded-xl border border-gray-300 py-3 pl-4 pr-12 outline-none transition focus:border-cyan-500 focus:ring-2 focus:ring-cyan-200"
          />

          <FaSearch className="absolute right-4 top-1/2 -translate-y-1/2 text-cyan-600" />
